...
<html>
<head>
<title>رزومه تحصیلی من | مهارت ها</title>
...
<section>
<h2 class="section-header">مهارت ها و توانمندی ها</h2>
<ol class="skills">
<li class="skill-list">ورزش بدمینتون به مدت پنج سال</li>
<li class="skill-list">نوازندگی پیانو به مدت ده سال</li>
<li class="skill-list">آشنایی مقدماتی با مبانی برنامه نویسی به زبان C</li>
<li class="skill-list">در حال یادگیری برنامه نویسی وب</li>
</ol>
</section>
